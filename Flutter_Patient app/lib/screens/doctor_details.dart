        ...
        children: <Widget>[
          CircleAvatar(
            ...
            backgroundImage: NetworkImage(
              "${ConstUrl.url}${doctor['doctor_profile']}",
            ),
          ...
          SizedBox(
            ...
            child: const Text(
              'Arbaminch Nechsar medical University',
              style: TextStyle(
                color: Colors.grey,
                fontSize: 15,
              ),
          ...
          SizedBox(
            width: Config.widthSize * 0.75,
            child: const Text(
              'Working at Arba Minch General Hospital',
              style: TextStyle(
                color: Colors.black,
                fontWeight: FontWeight.bold,
                fontSize: 15,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Config.spaceSmall,
          Text(
            'Dr. ${doctor['doctor_name']} is an experienced ${doctor['category']} Specialist at Arba Minch , graduated in 2008, and completed her training at Wolayta Sodo General Hospital.',
            style: const TextStyle(
